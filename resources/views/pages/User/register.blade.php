...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('/public/client/images/logos/favicon.png') }}" />
            ...
            <div class="card mb-0">
              <div class="card-body">
                <a href="./index.html" class="text-nowrap logo-img text-center d-block py-3 w-100">
                  <img src="{{ asset('/public/client/images/logos/dark-logo.svg') }}" width="180" alt="">
                </a>
                ...
                <div></div>
                @endif
                <form action="{{ URL::to('/handle-regis') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <a class="text-primary fw-bold ms-2" href="{{ URL::to('/login') }}">Đăng nhập</a>
                    </div>
                </form>
              </div>
            </div>
