...
<div class="container-fluid">
  ...
  <div class="card w-100">
    <div class="card-body p-4">
      ...
      <form action="<?php echo e(URL::to('document/doc/g-search-doc/'.$doccate_id)); ?>" method="GET">
        <?php echo csrf_field(); ?>
        <div class="row ">
          ...
          <div class="col-5">
            <div class="row">
              <div class="col-8">
                <input name="search" type="text" class="form-control" placeholder="Nhập tên văn bản ..." value="<?php echo e(request('search')); ?>">
              </div>
              <div class="col-4">
                <?php
                ...
                <select name="category_document" class="form-select" aria-label="Default select example">
                  ...
                  <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($type); ?>" <?php if(request('category_document') == $type): ?> selected <?php endif; ?>>
                      <?php echo e($type); ?>
          ...
          <div class="col-4">
            <div class="row">
              <div class="col">
                <input name="date_d" type="number" max="31" min="1" placeholder="Ngày" class="form-control" value="<?php echo e(request('date_d')); ?>">
              </div>
              <div class="col">
                <input name="date_m" type="number" max="12" min="1" placeholder="Tháng" class="form-control" value="<?php echo e(request('date_m')); ?>">
              </div>
              <div class="col">
                <input name="date_y" type="number" placeholder="Năm" class="form-control" value="<?php echo e(request('date_y')); ?>">
              </div>
            </div>
          </div>
        </div>
